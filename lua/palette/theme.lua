...
function theme.load(config)
  ...
  local highlights = {
    ...
    ["Folded"] = { link = "Comment" },
    ["IncSearch"] = { fg = base05, bg = dye.blend(base00, base08, 0.2) },
    ["LineNr"] = { fg = base03 },
    ...
    ["SpellLocal"] = { sp = base03, undercurl = true },
    ["SpellRare"] = { sp = base03, undercurl = true },
    ["SignColumn"] = { fg = base0B, bg = maybe.background },
    ["WinBar"] = { fg = base04, bg = maybe.background },
    ["WinBarNC"] = { link = "WinBar" },
    ["WinSeparator"] = { fg = dye.blend(base00, base0C, 0.5) },
    ...
    -- Typst {{{
    ["@markup.heading.1.typst"] = { link = "@neorg.headings.1.title.norg" },
    ["@markup.heading.2.typst"] = { link = "@neorg.headings.2.title.norg" },
    ["@markup.heading.3.typst"] = { link = "@neorg.headings.3.title.norg" },
    ["@markup.heading.4.typst"] = { link = "@neorg.headings.4.title.norg" },
    ["@markup.heading.5.typst"] = { link = "@neorg.headings.5.title.norg" },
    ["@markup.heading.6.typst"] = { link = "@neorg.headings.6.title.norg" },
    -- }}}
    ...
    ["DiagnosticUnderlineError"] = { sp = base08, underdashed = true },
    ["DiagnosticUnderlineHint"] = { sp = base0D, underdashed = true },
    ["DiagnosticUnderlineInfo"] = { sp = base0C, underdashed = true },
    ["DiagnosticUnderlineWarn"] = { sp = base09, underdashed = true },
    ...
    -- nvim-neorg/neorg {{{
    ["@neorg.headings.1.prefix.norg"] = { fg = base0D, underline = true },
    ["@neorg.headings.1.title.norg"] = { fg = dye.blend(base00, base0D, 0.75), bold = maybe.bold, underline = true },
    ["@neorg.headings.2.prefix.norg"] = { fg = base0A, underline = true },
    ["@neorg.headings.2.title.norg"] = { fg = dye.blend(base00, base0A, 0.75), bold = maybe.bold, underline = true },
    ["@neorg.headings.3.prefix.norg"] = { fg = base0B, underline = true },
    ["@neorg.headings.3.title.norg"] = { fg = dye.blend(base00, base0B, 0.75), bold = maybe.bold, underline = true },
    ["@neorg.headings.4.prefix.norg"] = { fg = base0C, underline = true },
    ["@neorg.headings.4.title.norg"] = { fg = dye.blend(base00, base0C, 0.75), bold = maybe.bold, underline = true },
    ["@neorg.headings.5.prefix.norg"] = { fg = base0E, underline = true },
    ["@neorg.headings.5.title.norg"] = { fg = dye.blend(base00, base0E, 0.75), bold = maybe.bold, underline = true },
    ["@neorg.headings.6.prefix.norg"] = { fg = base0F, underline = true },
    ["@neorg.headings.6.title.norg"] = { fg = dye.blend(base00, base0F, 0.75), bold = maybe.bold, underline = true },
    -- ["@neorg.headings.1.prefix.norg"] = { fg = base0C, bg = dye.blend(base00, base0C, 0.1), bold = maybe.bold },
    -- ["@neorg.headings.1.title.norg"] = { link = "@neorg.headings.1.prefix.norg" },
    -- ["@neorg.headings.2.prefix.norg"] = { fg = base0B, bg = dye.blend(base00, base0B, 0.1), bold = maybe.bold },
    -- ["@neorg.headings.2.title.norg"] = { link = "@neorg.headings.2.prefix.norg" },
    -- ["@neorg.headings.3.prefix.norg"] = { fg = base09, bg = dye.blend(base00, base09, 0.1), bold = maybe.bold },
    -- ["@neorg.headings.3.title.norg"] = { link = "@neorg.headings.3.prefix.norg" },
    -- ["@neorg.headings.4.prefix.norg"] = { fg = base0A, bg = dye.blend(base00, base0A, 0.1), bold = maybe.bold },
    -- ["@neorg.headings.4.title.norg"] = { link = "@neorg.headings.4.prefix.norg" },
    -- ["@neorg.headings.5.prefix.norg"] = { fg = base0E, bg = dye.blend(base00, base0E, 0.1), bold = maybe.bold },
    -- ["@neorg.headings.5.title.norg"] = { link = "@neorg.headings.5.prefix.norg" },
    -- ["@neorg.headings.6.prefix.norg"] = { fg = base08, bg = dye.blend(base00, base08, 0.1), bold = maybe.bold },
    -- ["@neorg.headings.6.title.norg"] = { link = "@neorg.headings.6.prefix.norg" },

    ["@neorg.headings.1.prefix"] = { link = "@neorg.headings.1.prefix.norg" },
    ["@neorg.headings.2.prefix"] = { link = "@neorg.headings.2.prefix.norg" },
    ["@neorg.headings.3.prefix"] = { link = "@neorg.headings.3.prefix.norg" },
    ["@neorg.headings.4.prefix"] = { link = "@neorg.headings.4.prefix.norg" },
    ["@neorg.headings.5.prefix"] = { link = "@neorg.headings.5.prefix.norg" },
    ["@neorg.headings.6.prefix"] = { link = "@neorg.headings.6.prefix.norg" },
    ...
    ["NotifyINFOBorder"] = { fg = dye.blend(base00, base0B, 0.4) },
    ["NotifyINFOTitle"] = { fg = base0B },
    ["NotifyINFOIcon"] = { fg = base0B },
    ["NotifyWARNBorder"] = { fg = dye.blend(base00, base09, 0.4) },
    ["NotifyWARNTitle"] = { fg = base09 },
    ["NotifyWARNIcon"] = { fg = base09 },
    ["NotifyDEBUGBorder"] = { fg = dye.blend(base00, base03, 0.4) },
    ["NotifyDEBUGTitle"] = { fg = base03 },
    ["NotifyDEBUGIcon"] = { fg = base03 },
    ["NotifyTRACEBorder"] = { fg = dye.blend(base00, base0D, 0.4) },
    ["NotifyTRACETitle"] = { fg = base0D },
    ["NotifyTRACEIcon"] = { fg = base0D },
    ["NotifyERRORBorder"] = { fg = dye.blend(base00, base08, 0.4) },
    ["NotifyERRORTitle"] = { fg = base08 },
    ["NotifyERRORIcon"] = { fg = base08 },
    -- }}}
