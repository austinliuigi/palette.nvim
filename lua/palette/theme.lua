...
function theme.load(config)
  ...
  local highlights = {
    ...
    ["DiagnosticUnderlineError"] = { sp = base08, underline = true },
    ["DiagnosticUnderlineHint"] = { sp = base0D, underline = true },
    ["DiagnosticUnderlineInfo"] = { sp = base0C, underline = true },
    ["DiagnosticUnderlineWarn"] = { sp = base09, underline = true },
