...
function theme.load(config)
  ...
  local highlights = {
    ...
    -- nvim-neorg/neorg {{{
    ["@neorg.headings.1.prefix.norg"] = { fg = base0D },
    ["@neorg.headings.1.title.norg"] = { fg = dye.blend(base00, base0D, 0.75), bold = maybe.bold },
    ["@neorg.headings.2.prefix.norg"] = { fg = base0A },
    ["@neorg.headings.2.title.norg"] = { fg = dye.blend(base00, base0A, 0.75), bold = maybe.bold },
    ["@neorg.headings.3.prefix.norg"] = { fg = base0B },
    ["@neorg.headings.3.title.norg"] = { fg = dye.blend(base00, base0B, 0.75), bold = maybe.bold },
    ["@neorg.headings.4.prefix.norg"] = { fg = base0C },
    ["@neorg.headings.4.title.norg"] = { fg = dye.blend(base00, base0C, 0.75), bold = maybe.bold },
    ["@neorg.headings.5.prefix.norg"] = { fg = base0E },
    ["@neorg.headings.5.title.norg"] = { fg = dye.blend(base00, base0E, 0.75), bold = maybe.bold },
    ["@neorg.headings.6.prefix.norg"] = { fg = base0F },
    ["@neorg.headings.6.title.norg"] = { fg = dye.blend(base00, base0F, 0.75), bold = maybe.bold },
